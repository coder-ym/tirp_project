      ...
      <div class="landlord-inner">
        ...
        <div class="header">
          <div class="left">
            ...
            <div class="info">
              <div class="name">{{ landlordData.hotelName }}</div>
              <div class="tags">
                <template v-for="(item, index) in landlordData.hotelTags">
                  <div class="item" :style="{ color: item.tagText.color }">
                    <span>{{ item.tagText.text }}</span>
                    <span v-if="index !== landlordData.hotelTags.length - 1" class="divider">|</span>
                  </div>
                </template>
              </div>
            </div>
