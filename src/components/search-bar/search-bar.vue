...
import { formatMonthDay } from '@/utils/date_tool'

const mainStore = useMainStore()

const startDateStr = formatMonthDay(mainStore.startDate, "MM.DD")
const endDateStr = formatMonthDay(mainStore.endDate, "MM.DD")
